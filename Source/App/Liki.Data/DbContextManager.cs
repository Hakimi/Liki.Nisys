...
using Liki.Code.Interface.Data;
...
namespace Liki.Data
{
    public class DbContextManager
    {
        ...
        public static void InitStorage(ILikiDbContext storage)
        {
            if (storage == null)
            {
        ...
        /// </summary>
        public static LikiDbContext Current
        {
            get
            {
        ...
        /// </summary>
        public static LikiDbContext CurrentFor(string key)
        {
        ...
        /// </summary>
        private static ILikiDbContext _storage { get; set; }
